...
function player(sx, sy)
	...
	function p:draw()
		...
		-- power UI
		print("pow:", 2, 120, black)
		rectfill(17, 120, 33, 124, dark_blue)
		rectfill(18, 121, 18 + (self.c * 3), 123, yellow) -- this math is hard-coded (no touching)
	end
	...
	function p:update()
		...
		if btn(use1) or btn(use2) then
			self.ct += dt * 0.35
			self.c = abs((sin(self.ct / 1.5) * self.max_c))
		...
		elseif self.ct > 0 then
			...
			if bd < 25 and bd > 5 then
				-- it's a hit
				sfx(1)
				active_world:hit_ball(self.c, bd)
			...
			self.c = 0
			self.ct = 0
			self.dy = lerp(self.dy, 10, 5)
		end

		self.y = min(self.sy, lerp(self.y, self.y + self.dy, 5))
...
function ball(sx, sy)
	...
	b.spd = 90 + flr(rnd(50)) -- random speed between 90 & 140
	b.hsp = 30
	b.h = false
	b.ve = 0
	b.an = 0
...

__sfx__

__music__
01 04054344
02 04064344
03 08424344
